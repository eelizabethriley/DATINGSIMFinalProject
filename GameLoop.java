...
public class GameLoop {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            // Check which area we are in, and go through the list of rooms in this house to execute the associated events for whatever room we are in.
                               ...
                               if (currentMap.equals(mendenhallMap) && stillPlaying) {
                                switch(currentRoom.name) {
                                    ...
                                    break;
                                    case "\nBASEMENT:\n":
                                        currentPlaythrough.gamePoints = gameMendenhall.basement(currentPlaythrough.gamePoints);
                                        stillPlaying = false;
                                    break;
                                    case "\nMENDENHALL EXIT:\n":
            ...
            //  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓  ↓
            if (currentPlaythrough.gamePoints >= 100 || currentPlaythrough.gamePoints <= -30) {
        ...
        if (currentPlaythrough.gamePoints >= 100) {
