...
public class Commands {
    ...
    public void showOptions() {
        ...
        // ** NAVIGATION METHODS **
    public Location goNorth(Location currentRoom, HashMap<String, Location> currentMap) {
    ...
    public Location goEast(Location currentRoom, HashMap<String, Location> currentMap) {
    ...
    public Location goWest(Location currentRoom, HashMap<String, Location> currentMap) {
    ...
    public Location goSouth(Location currentRoom, HashMap<String, Location> currentMap) {
